<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_RequestTimeout_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_RequestTimeout_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.RequestTimeout';
	protected $code = 408;
