<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_LengthRequired_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_LengthRequired_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.LengthRequired';
	protected $code = 411;
