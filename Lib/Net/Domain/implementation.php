<?php
/**
 * PHPGoodies:Lib_Net_Domain - A class for domain/host name manipulation (WORK IN PROGRESS)
 *
 ...
 */
class Lib_Net_Domain {

	/**
	 * FIXME: Create a means by which Generated DomainInfo may be dependency-injected
	 */
