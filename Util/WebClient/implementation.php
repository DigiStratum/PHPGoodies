<?php
/**
 * PHPGoodies:Util_WebClient - A layer on top of CURL to simulate browser behavior
 *
...
class Util_WebClient {
	...
	public function init($client, $os, $version = null) {
		...
		$this->response = PHPGoodies::instantiate('Lib.Net.Http.Response');
