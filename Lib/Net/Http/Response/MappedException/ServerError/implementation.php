...
/**
 * MappedException: 50410 SERVER ERROR
 */
class Lib_Net_Http_Response_MappedException_ServerError extends Lib_Net_Http_Response_MappedException {
	...
	public function __construct($message = '', $previous = null) {
		...
		$code = Lib_Net_Http_Response::HTTP_INTERNAL_SERVER_ERROR;
