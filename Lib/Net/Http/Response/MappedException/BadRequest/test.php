<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_BadRequest_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_BadRequest_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.BadRequest';
	protected $code = 400;
