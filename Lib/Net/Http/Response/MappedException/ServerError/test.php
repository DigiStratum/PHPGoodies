<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_ServerError_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_ServerError_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.ServerError';
	protected $code = 500;
