<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_Forbidden_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_Forbidden_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.Forbidden';
	protected $code = 403;
