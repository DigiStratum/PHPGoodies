<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_RequestEntityTooLarge_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_RequestEntityTooLarge_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.RequestEntityTooLarge';
	protected $code = 413;
