<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_NotAcceptable_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_NotAcceptable_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.NotAcceptable';
	protected $code = 406;
