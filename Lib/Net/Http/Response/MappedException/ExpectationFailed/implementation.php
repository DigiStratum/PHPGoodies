<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_ExpectationFailed - Extension of SPL's RuntimeException
 *
 ...
 */
class Lib_Net_Http_Response_MappedException_ExpectationFailed extends Lib_Net_Http_Response_MappedException {
