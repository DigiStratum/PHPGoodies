<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_Conflict - Extension of SPL's RuntimeException
 *
...
/**
 * MappedException: 409 CONFLICT
 */
abstract class Lib_Net_Http_Response_MappedException_Conflict extends Lib_Net_Http_Response_MappedException {
	...
	public function __construct($message = '', $previous = null) {
		...
		$code = Lib_Net_Http_Response::HTTP_CONFLICT;
