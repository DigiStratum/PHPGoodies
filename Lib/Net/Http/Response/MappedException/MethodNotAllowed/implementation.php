<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_MethodNotAllowed - Extension of SPL's RuntimeException
 *
...
/**
 * MappedException: 405 METHOD NOT ALLOWED
 * */
abstract class Lib_Net_Http_Response_MappedException_MethodNotAllowed extends Lib_Net_Http_Response_MappedException {
	...
	public function __construct($message = '', $previous = null) {
		...
		$code = Lib_Net_Http_Response::HTTP_METHOD_NOT_ALLOWED;
