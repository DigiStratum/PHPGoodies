<?php
/**
 * PHPGoodies:Lib_Dom_Node_Attribute - General HTML Attribute Generation support
 *
 ...
 */
class Lib_Dom_Node_Attribute extends Lib_Dom_Node implements Lib_Dom_Node_Interface {
