<?php
/**
 * PHPGoodies:HttpCookieCollection - A collection of HttpCookies
 *
...
PHPGoodies::import('Lib.Net.Http.HttpCookie');
...
class HttpCookieCollection {
	 ...
	 *
	 * @throws Exception if supplied param is not an HttpCookie instance
	 *
