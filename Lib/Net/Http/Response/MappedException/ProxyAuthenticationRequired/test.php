<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_ProxyAuthenticationRequired_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_ProxyAuthenticationRequired_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.ProxyAuthenticationRequired';
	protected $code = 407;
