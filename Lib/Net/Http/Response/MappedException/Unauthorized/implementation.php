<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_Unauthorized - Extension of SPL's RuntimeException
 *
...
/**
 * MappedException: 401 UNAUTHORIZED
 */
abstract class Lib_Net_Http_Response_MappedException_Unauthorized extends Lib_Net_Http_Response_MappedException {
	...
	public function __construct($message = '', $previous = null) {
		...
		$code = Lib_Net_Http_Response::HTTP_UNAUTHORIZED;
