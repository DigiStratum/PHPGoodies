<?php
/**
 * PHPGoodies:Lib_Dom_Node_Element - General HTML Element Generation support
 *
...
// Attributes
PHPGoodies::import('Lib.Dom.Node.Attribute');
PHPGoodies::import('Lib.Dom.Attributes.Global');

/**
 * NodeElement - General HTML Element Generation support
 */
class Lib_Dom_Node_Element extends Lib_Dom_Node implements Lib_Dom_Node_Interface {
	use Lib_Dom_Attributes_Global;
	...
	public function &setAttribute($name, $value = null) {
		...
		if (isset($attrNode)) {
			...
			$attrNode = new Lib_Dom_Node_Attribute($name, $value);
