<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_NotFound - Extension of SPL's RuntimeException
 *
...
/**
 * MappedException: 404 NOT FOUND
 */
abstract class Lib_Net_Http_Response_MappedException_NotFound extends Lib_Net_Http_Response_MappedException {
	...
	public function __construct($message = '', $previous = null) {
		...
		$code = Lib_Net_Http_Response::HTTP_NOT_FOUND;
