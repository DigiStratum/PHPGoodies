<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_Length_Required - Extension of SPL's RuntimeException
 *
...
/**
 * MappedException: 411 LENGTH REQUIRED
 */
abstract class Lib_Net_Http_Response_MappedException_LengthRequired extends Lib_Net_Http_Response_MappedException {
	...
	public function __construct($message = '', $previous = null) {
		...
		$code = Lib_Net_Http_Response::HTTP_LENGTH_REQUIRED;
