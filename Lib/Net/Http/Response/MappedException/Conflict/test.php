<?php
/**
 * PHPGoodies:Lib_Net_Http_Response_MappedException_Conflict_Test class test cases
 *
...
class Lib_Net_Http_Response_MappedException_Conflict_Test extends \PHPUnit_Framework_TestCase {

	protected $class = 'Lib.Net.Http.Response.MappedException.Conflict';
	protected $code = 409;
